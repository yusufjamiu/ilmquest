        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0 md:space-x-8">
            ...
            <div className="flex flex-col items-center text-center w-full md:w-1/3">
              ...
              <p className="text-gray-600">Ilmquest combines entertainment and education, making learning enjoyable and engaging. Through interactive games and challenges, players acquire knowledge and skills while having fun.
              .</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center w-full md:w-1/3">
              ...
              <p className="text-gray-600">lmquest's immersive content enables active learning, promoting deeper understanding and retention. Players engage with interactive simulations, videos, and animations that simplify complex concepts.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center w-full md:w-1/3">
              ...
              <p className="text-gray-600">Ilmquest's adaptive technology adjusts to individual players' pace and skill level, ensuring:
          ...
          <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row md:justify-between">
            ...
            <div className="grid grid-cols-3 gap-4 w-full md:w-auto">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="https://instagram.com/_ilmquest" className="hover:underline">Instagram</a></li>
